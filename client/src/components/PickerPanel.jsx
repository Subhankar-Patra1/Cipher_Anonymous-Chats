...
export default function PickerPanel({ onEmojiClick, onGifClick, disableGifTab = false }) {
    ...
    return (
        <div className="flex flex-col h-full w-full bg-white dark:bg-slate-900 rounded-lg overflow-hidden shadow-2xl border border-slate-200 dark:border-slate-700/50 transition-colors">
            {/* Tabs */}
            <div className="flex items-center gap-4 px-4 py-2 bg-slate-50 dark:bg-slate-800/80 border-b border-slate-200 dark:border-slate-700 transition-colors">
                <button
                    type="button"
